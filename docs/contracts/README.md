...
- shared hosted-facing public contracts: `lp.auth.*`, `lp.org.list.result@0.1.0`, `lp.project.list.result@0.1.0`, `lp.environment.list.result@0.1.0`, `lp.secret.list.result@0.1.0`, `lp.metering.event@0.1.0`
